...
import { GraduationCap, LayoutDashboard, ClipboardList, BookOpen, Users, LogOut, ChevronRight } from "lucide-react";
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b" style={{ borderColor: "hsl(var(--sidebar-border))" }}>
          ...
          {!collapsed && (
            <div>
              ...
              <p className="text-xs" style={{ color: "hsl(var(--sidebar-muted))" }}>Faculty Panel</p>
            </div>
          )}
          ...
          {!collapsed && (
            <div className="flex items-center gap-2 px-2 py-2 rounded-lg mb-2" style={{ background: "hsl(var(--sidebar-accent))" }}>
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs" style={{ color: "hsl(var(--sidebar-muted))" }}>Faculty / Teacher</p>
              </div>
            </div>
          )}
